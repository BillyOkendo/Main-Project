...
Clone this repository from the GitHub link (https://github.com/BillyOkendo/Main-Project) into your local machine. On your terminal, navigate into the directory where the respository is cloned, run 'code .' command to open it on VSC. Run the command 'json-server --watch db.json' on your terminal to open the webpage on your browser. You should see the single page application.
